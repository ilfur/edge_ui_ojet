...
Table.prototype._isTableRefreshNeeded = function (key, value, flags) {
  ...
  if ((key === 'contextMenu' && value === '#' + this._getTableId() + '_contextmenu') ||
      ...
      key === 'scrollToKey' || key === 'scrollPosition' ||
  ...
  if (isStart) {
    if (this._frozenStartIndex !== columnIndex) {
      if (this._frozenStartIndex != null) {
        this._removeFrozenEdge(this._frozenStartIndex, targetRow);
      }
      if (columnIndex != null) {
        this._applyFrozenEdge(columnIndex, targetRow);
        appliedEdge = true;
      }
    ...
    if (this._frozenEndIndex != null) {
      this._removeFrozenEdge(this._frozenEndIndex, targetRow);
    }
    if (columnIndex != null) {
      this._applyFrozenEdge(columnIndex, targetRow);
      appliedEdge = true;
 ...
 * @private
 */
TableStickyLayoutManager.prototype._applyFrozenEdge = function (columnIndex, targetRow) {
  var i;
  var tableBodyRows = this._table._getTableBodyRows();
  ...
  if (targetRow != null) {
    if (columnIndex === -1) {
      var targetSelectorCell = this._table._getTableBodySelectorCell(targetRow);
      if (targetSelectorCell != null) {
        targetSelectorCell.classList.add(Table.CSS_CLASSES._TABLE_FROZEN_EDGE);
      }
    } else {
      var targetCell = this._table._getTableBodyCell(null, columnIndex, targetRow);
      if (targetCell != null) {
 ...
 * @private
 */
TableStickyLayoutManager.prototype._removeFrozenEdge = function (columnIndex, targetRow) {
  var i;
  var tableBodyRows = this._table._getTableBodyRows();
  ...
  if (targetRow != null) {
    if (columnIndex === -1) {
      var targetSelectorCell = this._table._getTableBodySelectorCell(targetRow);
      if (targetSelectorCell != null) {
        targetSelectorCell.classList.remove(Table.CSS_CLASSES._TABLE_FROZEN_EDGE);
      }
    } else {
      var targetCell = this._table._getTableBodyCell(null, columnIndex, targetRow);
      if (targetCell != null) {
...
Table.prototype._setTableActionableMode = function (value, skipFocusReset) {
  ...
  if (value) {
    ...
    if (this._tableActionableElement != null) {
      disableAllFocusableElements(this._tableActionableBoundaryElement, null, null, true);
    }
